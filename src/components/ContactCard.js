...
export default function ContactCard() {
    return (
            ...
            <div className="p-6 text-gray-400 max-w-13 border-l border-blue-500">
        <p className='text-gray-800 text-lg'>Gabriel Loubier</p>
        <p className='text-gray-400'>( 603 ) 566 - 8197</p>
        <p className='text-gray-400'>gabrielloubier1@gmail.com</p>
        <div className='flex gap-4 py-2'>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.linkedin.com/in/gabriel-loubier-54731115a/"
          >
            <svg
              width="24"
              height="24"
          ...
          <a target="_blank" rel="noreferrer" href="https://github.com/ieatmangos/">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
